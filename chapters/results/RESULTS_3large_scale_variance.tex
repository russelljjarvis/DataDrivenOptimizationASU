...
\caption[Features of First Principal Component in Sparse PCA]{I identified the features associated with principal component 1 in the sparse PCA decomposition shown in Figure \ref{fig:spca-heatmap}.
