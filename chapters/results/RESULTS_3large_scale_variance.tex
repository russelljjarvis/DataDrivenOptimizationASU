...
\end{center}
\caption[PCA with Cluster Centers]{\textbf{PCA with Cluster Centers.} Similar Dimensionality reduction to above, but instead PCA is used instead of TSNE, and cluster centers drawn. The purpose of this plot is to introduce the prototype of a validation pathway, although specific data points shown here are spurious.}
