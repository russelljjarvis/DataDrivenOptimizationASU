...
\subsection{Two Data Types: Spike Feature Experiments, versus Electrophysiology reports}



\subsection{Executable NeuronUnit Allen Tests}
I created an Allen experiment to NeuronUnit test API, the API allows one to create neuronunit tests from a data base of experimental cellular recordings. Tests obtained via the Allen API, were designed to execute inside a BluePyOpt framework. An example of those tests being deployed is online: \url{https://github.com/fun-zoological-computing/BluePyOpt/blob/master/examples/bpo_nu_fusion/allen_efel_nu_deployed_tests_only-thesis.ipynb}
