...
\toprule
 Source & Cell ID & Subset of co-listed tests & Sample type  \\
\midrule
...
\bottomrule
\end{tabular}}
\caption[Properties of Different Experimental Data Used]{\textbf{Properties of the experimental data used in this section}.
Two data sources (NeuroElectro and the Allen Cell Types database) were used to fit neuron models.
All Allen Cell Types data comes from cortical neurons of various types.
Allen Cell Types data corresponds to individual recorded cells, and NeuroElectro data from mean feature values reported across many neurons of the same nominal type.}
