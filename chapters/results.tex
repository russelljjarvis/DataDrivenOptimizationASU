...
In section \textbf{1d}I discuss which model lead to the best fits overall, as I have ranked the quality of fits between models as if the models are competing against each other, I also come back to the issue of the best model performance in the discussion. %Later in the discussion, 
