 ...
 much of the value to the neuroscience modelling community comes from the implementation  of two fast python model simulations. Because these simulations are written in python, the code that implementations them is easy to understand and dispatch, because the models are fast they are useful in both network contexts, and optimization contexts. To
...
The author experimented with writing
PyNN, brain2, NEURON, jNeuroML-2.
