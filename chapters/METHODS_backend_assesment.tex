...
\begin{center}
\begin{figure}
\includegraphics{chapters/figures/backend_check_files/backend_check_4_2.png}
...
\begin{figure}
    ...
    \includegraphics{./chapters/figures/backend_check_files/backend_check_12_10.png}
...
\begin{figure}
    \centering
    \includegraphics{chapters/normal_distribution.png}
...
time taken on block 8.573923826217651
    ...
    \begin{center}
    \begin{figure}
    \includegraphics{chapters/figures/backend_check_files/backend_check_26_2.png}
