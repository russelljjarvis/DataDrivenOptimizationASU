...
\subsection{Streaming remote data}
\ref{sec:streaming}
...
\subsection{Analysis of variarance in Experiments and in Models}
$Druckmann 
...
\clearpage
\textbf{List of complete set of 48 electrophysiological features used here}
\begin{enumerate}
