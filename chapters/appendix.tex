...
%1. In the APPENDIX section the cover page should say APPENDIX A then underneath it should be the title.
...
\chapter{TABLES OF FITTED PARAMETERS AND TEST SCORES FOR MODELS AND DATA USED HERE}*
%Tables of Fitted Parameters and Test Scores for Models and Data Used Here}
...
\chapter{ACROSS MODEL PERFORMANCE COMPARISONS}
\begin{tabular}{lllrr}
\toprule
