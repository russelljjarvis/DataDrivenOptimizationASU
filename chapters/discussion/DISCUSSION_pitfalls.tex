...
\begin{figure}
    \centering
    \includegraphicsfigures/friendly_error_surface.png}
    \caption[Using only constant currents causes simple tractible error surfaces]{Because a constant current injection of just -10pA was applied, the error surface is simple informative and easy to navigate}
