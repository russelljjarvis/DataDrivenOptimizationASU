...
\begin{figure}
    ...
    \caption[Using only constant currents causes simple tractible error surfaces]{Because a constant current injection of $-10pA$ was applied, the error surface is simple informative and very easy to navigate, although only one slice into the error hypervolume is shown. Plots of GA learning speed provide reason to believe that all other slices into the hypervolume have simple convex shape}
