...
Conflicts between Rheobase value, and other static electrical measurements were observed in NeuroElectro and Allen static measurements.\\

When optimizing against NeuroElectro averaged measurements, and Allen Brain single cell observations, it was common to experience a conflicted ability for the cell to satisfy all constraints simultaneously. 
Models seemed to have particular difficulty in recapitulating an accurate fit for rheobase, while simultaneously satisfying the larger set of fitness criteria: time constant, input resistance, capacitance and resting membrane potential. There was better agreement between firing rate versus current (IFSlope) and the remainder of the electrical observations.
...
\begin{comment}
%%
% This table has now been integrated with the table below.
%%
\begin{table}[ht]
\centering
\resizebox{\textwidth}{!}{
...
{} & observation &   SEM 
Rheobase        &            128.868981&
SpikeThreshold      &          1.922930 &
SpikeHalfWidth      &          0.174910 &
SpikeAmplitude      &          1.488977 &
MembraneTimeConstant   &       2.562106 &
RestingMembranePotential  &    1.836370 &
InputResistance    &          27.928023 &
CellCapacitance    &          44.038610 &
\bottomrule
\end{tabular}}
\end{table}
\end{comment}
