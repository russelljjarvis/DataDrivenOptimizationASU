...
\subsubsection{Can a Rheobase Fitted model, generalize to other sweeps?}
No, it cannot reduced neuronal models are only okay at fitting one sweep at a time.

The utility of the Rheobase approach is to demonstrate a work flow. Its possible that some people
are interested in modelling single spiking behavior efficiently, however, in the context of network simulations,
You may be better of fitting to a multispiking sweep.
