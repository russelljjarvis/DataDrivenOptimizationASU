...
\begin{figure}
    ...
    \caption{An example of a multispiking waveform used as a basis for the Allen Brain Insistute cell types data base. Publication Gouwens rat \cite{gouwens2018systematic}}
