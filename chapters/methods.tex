...
This was the approach used to get the majority of results in this work, however some other important results where obtain using a second code pattern, which is stated in the appendix \ref{code:idiom2}.
%\end{lstlisting}
