...
\subsubsection{471819401 AdExp scores, agreement}
\begin{table}[ht]
\centering
\resizebox{\textwidth}{!}{
\begin{tabular}{lllll}
...
\subsubsection{Neocortex pyramidal cell layer 5-6, Izhikevich Model}
$\chi^{2}$
\begin{tabular}{lr}
\toprule
{} &         0 \\
...
\bottomrule
\end{tabular}}
\label{table:static_electrical_properties}
\end{table}
