...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\listadd{\titlelines}%
  {Towards Neuronal Deep Fakes:}             %<Enter the title of the dissertation
\listadd{\titlelines}%
  {Data Driven Optimization of Reduced Neuronal Models}            % If you want to
                                        ...
                                        %   second line
\newcommand*\Author{Russell Jarrod Jarvis}          %<Enter your name; must match official transcript
...
\newcommand*\defdate{Nov 2020}        %<Give month (written out fully) and year of
                                        %   the oral defense
...
\newcommand*{\chairlabel}{Co-Chair Rick Gerkin}        %<If you have co-chairs, replace this text with                                        %   'Co-Chair'
...
\listadd{\keywords}{optimisation}          %   additional names (up to 6)
...
\input{chapters/abstract}             %<Enter the name of the .tex file containing your
...
\input{chapters/acknowledgements}      %<Enter the name of the .tex file containing your
